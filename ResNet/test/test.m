...
p = dir('/home/lab535-user1/chenshm/Writer_Ident/data/ICDAR2013/icdar2013_test_Line/icdar2013_train_all_Line_patches256_new/*jpg');
ff = [];
%------------------------------
for i = 1:200:numel(p)
    disp(i);
    ...
    for j=1:min(200,numel(p)-i+1)
        str = strcat('/home/lab535-user1/chenshm/Writer_Ident/data/ICDAR2013/icdar2013_test_Line/icdar2013_train_all_Line_patches256_new/',p(i+j-1).name);
...
save('../test/icdar2013_all_fc_patches256_tain.mat','ff','-v7.3');
%}
...
save('../test/icdar2013_all_fc_patches256_test.mat','ff','-v7.3');
