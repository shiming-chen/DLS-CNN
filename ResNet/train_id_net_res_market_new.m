...
imdb = load('./data/icdar2013_patches256.mat') ;
imdb = imdb.imdb;
% -------------------------------------------------------------------------
...
opts.train.expDir = './data/icdar2013_patches256_drop0.5_B128_LR0.1_new';
opts.train.derOutputs = {'objective', 1} ;
%opts.train.gamma = 0.9;
opts.train.momentum = 0.9;
%opts.train.constraint = 100;
opts.train.learningRate = [0.1*ones(1,45),0.01*ones(1,10)] ;
